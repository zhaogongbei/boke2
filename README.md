...
在线演示 ➡️ [http://zhaojiabin.shop/](http://zhaojiabin.shop/)

官方文档 ➡️ [vhAstro-Theme](http://zhaojiabin.shop/article/astro-theme-vhastro-theme)
	...
	data: [
		{
			...
			auther: "赵佳彬博客",
			date: "2025-03-06",
			link: "http://zhaojiabin.shop/article/Lenis-in-Astro",
		...
		},
		{
			...
			auther: "赵佳彬博客",
			date: "2025-03-03",
			link: "http://zhaojiabin.shop/article/astro-twikoo",
		...
		},
		{
			...
			auther: "赵佳彬博客",
			date: "2025-03-02",
			link: "http://zhaojiabin.shop/article/astro-theme-vhastro-theme",
...
export default {
  ...
  WebSites: [
    ...
    { text: '赵佳彬API', link: 'https://api.vvhan.com', icon: 'WebSite_api' },
